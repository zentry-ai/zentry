...
export function FormView({ settings, onChange }: FormViewProps) {
    ...
    onChange({
      ...
      zentry: {
        ...
        embedder: {
          ...settings.zentry.embedder,
          config: {
            ...settings.zentry.embedder.config,
            [key]: value,
          },
        },
      },
  ...
  const needsLlmApiKey = settings.zentry?.llm?.provider?.toLowerCase() !== "ollama"
  const needsEmbedderApiKey = settings.zentry?.embedder?.provider?.toLowerCase() !== "ollama"
  const isLlmOllama = settings.zentry?.llm?.provider?.toLowerCase() === "ollama"
  const isEmbedderOllama = settings.zentry?.embedder?.provider?.toLowerCase() === "ollama"
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Select 
              value={settings.zentry?.llm?.provider || ""}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={settings.zentry?.llm?.config?.model || ""}
          ...
          {isLlmOllama && (
            <div className="space-y-2">
              ...
              <Input
                ...
                value={settings.zentry?.llm?.config?.ollama_base_url || ""}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  value={settings.zentry?.llm?.config?.api_key || ""}
            ...
            <div className="space-y-6 pt-2">
              <div className="space-y-2">
                <div className="flex justify-between">
                  <Label htmlFor="temperature">Temperature: {settings.zentry?.llm?.config?.temperature}</Label>
                </div>
                <Slider
                  id="temperature"
                  min={0}
                  max={1}
                  step={0.1}
                  value={[settings.zentry?.llm?.config?.temperature || 0.7]}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  placeholder="2000"
                  value={settings.zentry?.llm?.config?.max_tokens || ""}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Select 
              value={settings.zentry?.embedder?.provider || ""} 
          ...
          <div className="space-y-2">
            ...
            <Input
              id="embedder-model"
              placeholder="Enter model name"
              value={settings.zentry?.embedder?.config?.model || ""}
          ...
          {isEmbedderOllama && (
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="http://host.docker.internal:11434"
                value={settings.zentry?.embedder?.config?.ollama_base_url || ""}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="env:API_KEY"
                  value={settings.zentry?.embedder?.config?.api_key || ""}
