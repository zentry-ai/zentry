...
```bash
curl -sL https://raw.githubusercontent.com/zentryai/zentry/main/openmemory/run.sh | bash
```
...
```bash
curl -sL https://raw.githubusercontent.com/zentryai/zentry/main/openmemory/run.sh | OPENAI_API_KEY=your_api_key bash
```
