...
This directory contains the backend API for OpenMemory, built with FastAPI and SQLAlchemy. This also runs the Zentry MCP Server that you can use with MCP clients to remember things.
