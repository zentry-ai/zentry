...
from embedchain.config.llm.base import (
    ...
    DEFAULT_PROMPT_WITH_ZENTRY_MEMORY_TEMPLATE,
    ...
    def generate_prompt(self, input_query: str, contexts: list[str], **kwargs: dict[str, Any]) -> str:
        ...
        if prompt_contains_history:
            ...
            if (
                ...
                if memories:
                    # swap in the template with Zentry memory template
                    prompt = DEFAULT_PROMPT_WITH_ZENTRY_MEMORY_TEMPLATE.substitute(
