...
from embedchain.config import AppConfig, CacheConfig, ChunkerConfig, ZentryConfig
...
class App(EmbedChain):
    ...
    def __init__(
        ...
        memory_config: ZentryConfig = None,
        ...
        self.zentry_memory = None
        if self.memory_config is not None:
            self.zentry_memory = Memory()
    ...
    def from_config(
        ...
        memory_config = ZentryConfig(**memory_config_data) if memory_config_data else None
