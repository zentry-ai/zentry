...
def main():
    ...
    parser.add_argument("--technique_type", choices=TECHNIQUES, default="zentry", help="Memory technique to use")
    ...
    if args.technique_type == "zentry":
        if args.method == "add":
            ...
            output_file_path = os.path.join(
                args.output_folder,
                f"zentry_results_top_{args.top_k}_filter_{args.filter_memories}_graph_{args.is_graph}.json",
            )
