# Zentry: Building Production‑Ready AI Agents with Scalable Long‑Term Memory

[![arXiv](https://img.shields.io/badge/arXiv-Paper-b31b1b.svg)](https://arxiv.org/abs/2504.19413)
[![Website](https://img.shields.io/badge/Website-Project-blue)](https://zentry.gg/research)

This repository contains the code and dataset for our paper: **Zentry: Building Production‑Ready AI Agents with Scalable Long‑Term Memory**.

## 📋 Overview

This project evaluates Zentry and compares it with different memory and retrieval techniques for AI systems:
...
│   ├── Zentry/             # Implementation of the Zentry technique
...
# Zentry API keys (for Zentry and Zentry+ techniques)
Zentry_API_KEY="your-Zentry-api-key"
Zentry_PROJECT_ID="your-Zentry-project-id"
Zentry_ORGANIZATION_ID="your-Zentry-organization-id"
...
```bash
# Run Zentry experiments
make run-Zentry-add         # Add memories using Zentry
make run-Zentry-search      # Search memories using Zentry

# Run Zentry+ experiments (with graph-based search)
make run-Zentry-plus-add    # Add memories using Zentry+
make run-Zentry-plus-search # Search memories using Zentry+
...
```bash
python run_experiments.py --technique_type [Zentry|rag|langmem] [additional parameters]
```
...
|-----------|-------------|---------|
| `--technique_type` | Memory technique to use (Zentry, rag, langmem) | Zentry |
