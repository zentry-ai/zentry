...
class MemoryADD:
    def __init__(self, data_path=None, batch_size=2, is_graph=False):
        self.zentry_client = MemoryClient(
            api_key=os.getenv("zentry_API_KEY"),
            org_id=os.getenv("zentry_ORGANIZATION_ID"),
            project_id=os.getenv("zentry_PROJECT_ID"),
        )

        self.zentry_client.update_project(custom_instructions=custom_instructions)
    ...
    def process_conversation(self, item, idx):
        ...
        self.zentry_client.delete_all(user_id=speaker_a_user_id)
        self.zentry_client.delete_all(user_id=speaker_b_user_id)
