...
import ThemeAwareLogo from "@/components/zentry/theme-aware-logo";
import Link from "next/link";
import GithubButton from "@/components/zentry/github-button";
      ...
      <div className={`bg-[#f8fafc] dark:bg-zinc-900 text-[#1e293b] ${isDarkMode ? "dark" : ""}`}>
        <header className="h-16 border-b border-[#e2e8f0] flex items-center justify-between px-4 sm:px-6 bg-white dark:bg-zinc-900 dark:border-zinc-800 dark:text-white">
          ...
          <div className="md:flex items-center hidden">
            ...
            <GithubButton url="https://github.com/zentry-ai/zentry/tree/main/examples" />

            <Link href={"https://app.zentry.gg/"} target="_blank" className="py-1 ml-2 px-4 font-semibold dark:bg-zinc-100 dark:hover:bg-zinc-200 bg-zinc-800 text-white rounded-full hover:bg-zinc-900 dark:text-[#475569]">
              Playground
            </Link>
          </div>
        </header>
