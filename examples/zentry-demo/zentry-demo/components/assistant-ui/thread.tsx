...
import MarkdownRenderer from "../zentry/markdown";
...
import GithubButton from "../zentry/github-button";
              ...
              <ThreadListPrimitive.Root className="flex flex-col items-stretch gap-1.5 h-full dark:text-white">
                <ThreadListPrimitive.New asChild>
                  ...
                  >
                    ...
                    <GithubButton url="https://github.com/zentry-ai/zentry/tree/main/examples" className="w-full rounded-lg h-9 pl-2 text-sm font-semibold bg-zinc-800 dark:border-zinc-800 dark:text-white text-white hover:bg-zinc-900" text="View on Github" />

                    <Link
                      href={"https://app.zentry.gg/"}
                      target="_blank"
        ...
        <div className="flex w-full flex-grow flex-col items-center justify-start">
          <div className="flex flex-col items-center justify-center h-full">
            <div className="text-[2rem] leading-[1] tracking-[-0.02em] md:text-4xl font-bold text-[#1e293b] dark:text-white mb-2 text-center md:w-full w-5/6">
              zentry - ChatGPT with memory
            </div>
            <p className="text-center text-md text-[#1e293b] dark:text-white mb-2 md:w-3/4 w-5/6">
              A personalized AI chat app powered by zentry that remembers your
