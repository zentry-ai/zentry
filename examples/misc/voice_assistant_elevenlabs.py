"""
Personal Voice Assistant with Memory (Whisper + CrewAI + Zentry + ElevenLabs)
...
- Remember user preferences and facts using Zentry memory
...
- Python packages: openai, elevenlabs, crewai, zentryai, pyaudio
"""
...
def get_agent_response(user_input):
    ...
    try:
        ...
        crew = Crew(
            ...
            verbose=True,
            memory=True,
            memory_config={"provider": "zentry", "config": {"user_id": USER_ID}},
        )
        result = crew.kickoff()
...
# ------------------ MAIN LOOP ------------------
def run_voice_agent():
    print("🧠 Voice agent (Whisper + Zentry + ElevenLabs) is ready! Say something.")
    while True:
