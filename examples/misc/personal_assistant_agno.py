...
In order to run this file, you need to set up your Zentry API at Zentry platform and also need a OpenAI API key.
...
print(
    chat_user(
        ...
        image_path="travel_items.jpeg",  # this will be added to Zentry memory
        user_id=user_id,
    )
)
