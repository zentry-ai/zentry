"""
Memory-Powered Movie Recommendation Assistant (Grok 3 + Zentry)
This script builds a personalized movie recommender that remembers your preferences
(e.g. dislikes horror, loves romcoms) using Zentry as a memory layer and Grok 3 for responses.

In order to run this file, you need to set up your Zentry API at Zentry platform and also need an XAI API key.
...
# Configure Me  0 with Grok 3 and Qdrant
config = {
