# Zentry Assistant Chrome Extension

A powerful Chrome extension that combines AI chat with your personal knowledge base through zentry. Get instant, personalized answers about video content while leveraging your own knowledge and memories - all without leaving the page.
...
- Memory capabilities powered by Zentry
- Dark mode support
...
- **Future zentry Integration**: Personalized responses based on your knowledge (coming soon)
