...
const apiKey = process.env.ZENTRY_API_KEY || "";
// const client = new MemoryClient({ apiKey, host: 'https://api.zentry.gg', organizationId: "org_gRNd1RrQa4y52iK4tG8o59hXyVbaULikgq4kethC", projectId: "proj_7RfMkWs0PMgXYweGUNKqV9M9mgIRNt5XcupE7mSP" });
// const client = new MemoryClient({ apiKey, host: 'https://api.zentry.gg', organizationName: "saket-default-org", projectName: "default-project" });
const client = new MemoryClient({ apiKey, host: "https://api.zentry.gg" });
