...
from zentry.vector_stores.base import VectorStoreBase
...
class AzureAISearch(VectorStoreBase):
    def __init__(
        ...
        self.search_client._client._config.user_agent_policy.add_user_agent("zentry")
        self.index_client._client._config.user_agent_policy.add_user_agent("zentry")
