...
import zentry
from zentry.memory.setup import get_or_create_user_id
...
if not isinstance(ZENTRY_TELEMETRY, bool):
    raise ValueError("ZENTRY_TELEMETRY must be a boolean value.")
...
class AnonymousTelemetry:
    ...
    def capture_event(self, event_name, properties=None, user_email=None):
        ...
        properties = {
            ...
            "client_version": zentry.__version__,
