...
from zentry.llms.azure_openai import AzureOpenAILLM
...
def mock_openai_client():
    with patch("zentry.llms.azure_openai.AzureOpenAI") as mock_openai:
        mock_client = Mock()
...
def test_generate_with_http_proxies(default_headers):
    ...
    with (
        patch("zentry.llms.azure_openai.AzureOpenAI") as mock_azure_openai,
        ...
        config = BaseLlmConfig(
            ...
            top_p=TOP_P,
            api_key="test",
            http_client_proxies="http://testproxy.zentry.net:8000",
        ...
        mock_http_client.assert_called_once_with(proxies="http://testproxy.zentry.net:8000")
