...
# from zentry.vector_stores.weaviate import Weaviate, OutputData
...
#         patcher = patch('zentry.vector_stores.weaviate.weaviate.connect_to_local', return_value=self.client_mock)
