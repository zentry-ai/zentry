...
from zentry.vector_stores.elasticsearch import ElasticsearchDB, OutputData
...
class TestElasticsearchDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch("zentry.vector_stores.elasticsearch.Elasticsearch", return_value=self.client_mock)
    ...
    def test_insert(self):
        ...
        # Mock bulk operation
        with patch("zentry.vector_stores.elasticsearch.bulk") as mock_bulk:
