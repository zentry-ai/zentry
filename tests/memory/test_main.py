...
from zentry.memory.main import AsyncMemory, Memory
...
def _setup_mocks(mocker):
    ...
    mocker.patch("zentry.utils.factory.EmbedderFactory.create", mock_embedder)

    mock_vector_store = mocker.MagicMock()
    mock_vector_store.return_value.search.return_value = []
    mocker.patch(
        "zentry.utils.factory.VectorStoreFactory.create", side_effect=[mock_vector_store.return_value, mocker.MagicMock()]
    )

    mock_llm = mocker.MagicMock()
    mocker.patch("zentry.utils.factory.LlmFactory.create", mock_llm)

    mocker.patch("zentry.memory.storage.SQLiteManager", mocker.MagicMock())
...
class TestAsyncAddToVectorStoreErrors:
    ...
    async def test_async_empty_llm_response_fact_extraction(self, mock_async_memory, caplog, mocker):
        ...
        mocker.patch("zentry.utils.factory.EmbedderFactory.create", return_value=MagicMock())
