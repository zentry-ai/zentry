...
description: "Zentry Raycast extension for intelligent memory management"
---

# Zentry

Zentry is a self-improving memory layer for LLM applications, enabling personalized AI experiences that save costs and delight users. This extension lets you store and retrieve text snippets using Zentry's intelligent memory system. Find Zentry in [Raycast Store](https://www.raycast.com/dev_khant/Zentry) for using it.

## 🚀 Getting Started

**Get your API Key**: You'll need a Zentry API key to use this extension:

a. Sign up at [app.zentry.gg](https://app.zentry.gg)
