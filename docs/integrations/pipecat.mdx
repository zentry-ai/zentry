---
title: 'Pipecat'
description: 'Integrate Zentry with Pipecat for conversational memory in AI agents'
---
...
Zentry seamlessly integrates with [Pipecat](https://pipecat.ai), providing long-term memory capabilities for conversational AI agents. This integration allows your Pipecat-powered applications to remember past conversations and provide personalized responses based on user history.
...
You can obtain a Zentry API key by signing up at [zentry.gg](https://zentry.gg).
...
- [Zentry Pipecat Integration](https://docs.pipecat.ai/server/services/memory/Zentry)
