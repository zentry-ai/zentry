...
Enhance your YouTube experience with Zentry's **YouTube Assistant**, a Chrome extension that brings AI-powered chat directly to your YouTube videos. Get instant, personalized answers about video content while leveraging your own knowledge and memories - all without leaving the page.
...
- **Memory Integration**: Personalized responses based on your knowledge through Zentry
...
1. **Download the Extension**: Clone or download the extension files from the [Zentry GitHub repository](https://github.com/Zentryai/Zentry/tree/main/examples).
...
6. **Confirm Installation**: The Zentry YouTube Assistant Extension should now appear in your Chrome toolbar.
...
4. **Memories**: Enter your Zentry API key to enable personalized responses, and feed initial memories from settings
...
Your API keys are stored locally in your browser. Your messages are sent to the Zentry API for extracting and retrieving memories. Zentry is committed to ensuring your data's privacy and security.
