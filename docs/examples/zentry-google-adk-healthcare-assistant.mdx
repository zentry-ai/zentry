---
title: 'Healthcare Assistant with Zentry and Google ADK'
description: 'Build a personalized healthcare agent that remembers patient information across conversations using Zentry and Google ADK'
---
