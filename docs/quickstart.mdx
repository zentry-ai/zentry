...
Zentry offers two powerful ways to leverage our technology: [our managed platform](#zentry-platform-managed-solution) and [our open source solution](#zentry-open-source).

Check out our [Playground](https://zentry.gg/placeholder) to see Zentry in action.

<CardGroup cols={2}>
  <Card title="Zentry Platform (Managed Solution)" icon="chart-simple" href="#zentry-platform-managed-solution">
    Better, faster, fully managed, and hassle free solution.
  </Card>
  <Card title="Zentry Open Source" icon="code-branch" href="#zentry-open-source">
...
Our fully managed platform provides a hassle-free way to integrate Zentry's capabilities into your AI agents and assistants. Sign up for Zentry platform [here](https://zentry.gg/placeholder).

The Zentry SDK supports both Python and JavaScript, with full [TypeScript](/platform/quickstart/#4-11-working-with-zentry-in-typescript) support as well.

Follow the steps below to get started with Zentry Platform:

1. [Install Zentry](#1-install-zentry)
...
1. Sign in to [Zentry Platform](https://zentry.gg/placeholder)
2. Copy your API Key from the dashboard

![Get API Key from Zentry Platform](/images/platform/api-key.png)
...
```bash cURL
curl -X POST "https://api.zentry.gg/placeholder/v1/memories/" \
...
```bash cURL
curl -X POST "https://api.zentry.gg/placeholder/v1/memories/search/?version=v2" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "query": "I'm craving some pizza. Any recommendations?",
...
```bash cURL
curl -X GET "https://api.zentry.gg/placeholder/v1/memories/?version=v2&page=1&page_size=50" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "filters": {
...
<Card title="Zentry Platform" icon="chart-simple" href="/platform/overview">
  Learn more about Zentry platform
</Card>

## Zentry Open Source

Our open-source version is available for those who prefer full control and customization. You can self-host Zentry on your infrastructure and integrate it with your AI agents and assistants. Checkout our [GitHub repository](https://github.com/zentry-ai/zentry)

Follow the steps below to get started with Zentry Open Source:

1. [Install Zentry Open Source](#1-install-zentry-open-source)
...
<CardGroup cols={2}>
<Card title="Zentry OSS Python SDK" icon="python" href="/open-source/python-quickstart">
  Learn more about Zentry OSS Python SDK
</Card>
<Card title="Zentry OSS Node.js SDK" icon="node" href="/open-source-typescript/quickstart">
