...
zentry provides a powerful set of APIs that allow you to integrate advanced memory management capabilities into your applications. Our APIs are designed to be intuitive, efficient, and scalable, enabling you to create, retrieve, update, and delete memories across various entities such as users, agents, apps, and runs.
...
- **Multi-org/project Support**: Specify organization and project when initializing the zentry client to attribute API usage appropriately
...
Example with the zentry Python package:
...
To begin using the zentry API, you'll need to:

1. Sign up for a [zentry account](https://app.zentry.gg) and obtain your API key.
