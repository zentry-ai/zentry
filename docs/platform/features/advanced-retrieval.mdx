...
Zentry's **Advanced Retrieval** feature delivers superior search results by leveraging state-of-the-art search algorithms. Beyond the default search functionality, Zentry offers the following advanced retrieval modes:
