...
Learn about the key features and capabilities that make Zentry a powerful platform for memory management and retrieval.
...
<CardGroup>
  ...
  <Card title="Direct Import" icon="message-bot" href="/features/direct-import">
    Tailor the behavior of your Zentry instance with custom prompts for specific use cases or domains.
  </Card>
