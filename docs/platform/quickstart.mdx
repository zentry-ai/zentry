---
title: Guide
description: 'Get started with Zentry Platform in minutes'
icon: "book"
iconType: "solid"
---
...
<Note type="info">
  🎉 Looking for TypeScript support? Zentry has you covered! Check out an example [here](/platform/quickstart/#4-11-working-with-Zentry-in-typescript).
</Note>
...
1. Sign in to [Zentry Platform](https://Zentry.dev/pd-api)
...
```bash cURL
curl -X POST "https://api.zentry.gg/v1/memories/" \
...
![Zentry Platform Activity](/images/platform/activity.png)
...
```bash cURL
curl -X POST "https://api.zentry.gg/v1/memories/search/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "query": "What should I cook for dinner today?",
...
```bash cURL
curl -X POST "https://api.zentry.gg/v1/memories/search/?version=v2" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "query": "What do you know about me?",
...
```bash cURL
curl -X GET "https://api.zentry.gg/v1/entities/" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
{
    "count": 204,
    "next": "https://api.zentry.gg/v1/memories/?user_id=alex&output_format=v1.1&page=2&page_size=50",
    "previous": null,
    "results": 
    [
            {
...
```bash cURL
curl -X GET "https://api.zentry.gg/v1/memories/?agent_id=ai-tutor&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
{
    "count": 78,
    "next": "https://api.zentry.gg/v1/memories/?agent_id=ai-tutor&output_format=v1.1&page=2&page_size=50",
    "previous": null,
    "results": 
    [
            {
...
```bash cURL
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&run_id=trip-planning-2024&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X GET "https://api.zentry.gg/v1/memories/582bbe6d-506b-48c6-a4c6-5df3b1e63428" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
# Get memories with specific categories
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&categories=likes" \
     -H "Authorization: Token your-api-key"

# Get memories with multiple categories
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&categories=likes,food_preferences" \
     -H "Authorization: Token your-api-key"

# Custom pagination with categories
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&categories=likes&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"

# Get memories with specific keywords
curl -X GET "https://api.zentry.gg/v1/memories/?user_id=alex&keywords=to play&page=1&page_size=50" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
# Default (No Pagination)
curl -X GET "https://api.zentry.gg/v1/memories/?version=v2" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "filters": {
...
# Pagination (You can also use the page and page_size parameters)
curl -X GET "https://api.zentry.gg/v1/memories/?version=v2&page=1&page_size=50" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "filters": {
...
curl -X GET "https://api.zentry.gg/v1/memories/<memory-id-here>/history/" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X PUT "https://api.zentry.gg/v1/memories/memory-id-here" \
        -H "Authorization: Token your-api-key" \
        -H "Content-Type: application/json" \
        -d '{
            "message": "I recently tried chicken and I loved it. I'm thinking of trying more non-vegetarian dishes.."
...
```bash cURL
curl -X DELETE "https://api.zentry.gg/v1/memories/memory-id-here" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X DELETE "https://api.zentry.gg/v1/memories/?user_id=alex" \
     -H "Authorization: Token your-api-key"
```
...
```bash cURL
curl -X DELETE "https://api.zentry.gg/v2/entities/user/alex" \
     -H "Authorization: Token your-api-key"
```
...
```
```bash cURL
curl -X PUT "https://api.zentry.gg/v1/memories/batch/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "memories": [
...
```
```bash cURL
curl -X DELETE "https://api.zentry.gg/v1/memories/batch/" \
     -H "Authorization: Token your-api-key" \
     -H "Content-Type: application/json" \
     -d '{
         "memory_ids": [
