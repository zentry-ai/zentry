...
Zentry provides two core operations for managing memories in AI applications: adding new memories and searching existing ones. This guide covers how these operations work and how to use them effectively in your application.


## Core Operations

Zentry exposes two main endpoints for interacting with memories:
