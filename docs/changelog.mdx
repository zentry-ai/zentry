...
**Improvements:**
- **Client:** Added support for Zentry to work with Chrome Extensions
</Update>
...
**Improvements:**
- **Demo:** Updated Demo ZentryAI
- **Client:** Enhanced Ping method in Zentry Client
...
- **Bump `Zentryai` to use `2.1.12`**

</Update>

<Update label="2025-03-26" description="v2.1.12">
**New Features:**
- **Zentry OSS:** Support infer param
...
- **Graph Playground:** Enabled for @zentry.gg users
